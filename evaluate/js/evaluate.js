...
function firstPage() {
    ...
    $.ajax({
        url: "/TeachDocument2/evaluateItem/searchForStu",
        type: "post",
        dataType: "json",
        data: {
            "term":term,
...
//    alert("@@@"+login_account+"!!!!");
//    alert(rowList[0].columns.edu_admin_eva_id);
    ...
    for (var i = 0; i < rowList.length; i++) {
        ...
        temp += rowList[i].columns.id;		//此id为task_id
        ...
        //2015-9-18
        //如果当前登录的信息员没有评价过的task就显示	“进行评价”，否则显示	“查看评价”，且只能查看自己的评价		信息员和教学办都没有权利修改评价！！！，如需更改教学办删除评价，信息员重新评价
        if(rowList[i].columns.from_whom==login_account){
