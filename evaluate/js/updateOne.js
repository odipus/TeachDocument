...
function loadElement(a){
    ...
    temp += datalist[0].columns.course_name + '<input type="hidden"id="remark_id"  name="remark_id" value="'+datalist[0].columns.remark_id+'"/></td>';
...
//    alert("task_id="+datalist[0].columns.id);																	//test
