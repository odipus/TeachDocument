...
function loadElement(a){
    ...
    temp += '<tr> <td align="center" width="100" height="40"><font size="3">评价内容：</font></td> <td colspan="2" align="center" width="100" height="80"><a href="../evaluateTables/DownloadLeader?id='+datalist[0].columns.remark_id+'" target="_self"><img onclick="" class="evaimg" src="../img/pdfpic.png" title="点击下载！"></a></td> </tr> ' +
